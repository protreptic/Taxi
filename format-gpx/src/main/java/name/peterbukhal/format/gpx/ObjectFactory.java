 ...
 * generated in the name.peterbukhal.format.gpx package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: name.peterbukhal.format.gpx
     * 
     */
