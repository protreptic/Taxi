package name.peterbukhal.android.taxi.partner.service.ntp;
...
public final class NtpMessage implements Parcelable {
    ...
    public static final Creator<NtpMessage> CREATOR = new Creator<NtpMessage>() {

        @Override
        public NtpMessage createFromParcel(Parcel in) {
            return new NtpMessage(in);
        }

        @Override
        public NtpMessage[] newArray(int size) {
            return new NtpMessage[size];
        }
