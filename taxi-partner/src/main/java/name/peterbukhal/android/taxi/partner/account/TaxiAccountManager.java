...
public final class TaxiAccountManager {
    ...
    public void addAccount(Activity activity, AccountManagerCallback<Bundle> callback) {
        mAccountManager.addAccount(TaxiPartnerAccount.ACCOUNT_TYPE, null, null, null, activity, callback, null);
    }
    ...
    public String peekAuthToken(Account account) {
        String token = mAccountManager.peekAuthToken(account, TaxiPartnerAccount.ACCOUNT_TYPE);

        return (TextUtils.isEmpty(token) ? "#" : token);
    }

    public void invalidateToken(String token) {
        mAccountManager.invalidateAuthToken(TaxiPartnerAccount.ACCOUNT_TYPE, token);
    }
    ...
    public void getToken(Account account, AccountManagerCallback<Bundle> callback) {
        ...
        mAccountManager.getAuthToken(account, TaxiPartnerAccount.ACCOUNT_TYPE, Bundle.EMPTY, true, callback, null);
    }

    public void setToken(Account account, String token) {
        mAccountManager.setAuthToken(account, TaxiPartnerAccount.ACCOUNT_TYPE, token);
    }
    ...
    public List<Account> getAccounts() {
        return Collections.unmodifiableList(
                Arrays.asList(mAccountManager.getAccountsByType(TaxiPartnerAccount.ACCOUNT_TYPE)));
    }
    ...
    public Account getDefaultAccount() {
        ...
        return new TaxiPartnerAccount(accountName);
    }
