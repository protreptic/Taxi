...
import static name.peterbukhal.android.taxi.partner.account.TaxiAccountManager.EXTRA_ACCOUNT;
import static name.peterbukhal.android.taxi.partner.account.TaxiPartnerAccount.ACCOUNT_AUTHORITY;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void requestSync() {
        ContentResolver.requestSync(mAccount, ACCOUNT_AUTHORITY, EMPTY);
    }
                ...
                try {
                    ...
                    if (keyIntent != null) {
                        ...
                        if (bundle.containsKey(AccountManager.KEY_ACCOUNT_NAME)
                            ...
                            runApplication(new TaxiPartnerAccount(
                        ...
                        switch ((int) profile.getIdentifier()) {
                            ...
                            case MANAGE_ACCOUNTS: {
                                ...
                                intent.putExtra(Settings.EXTRA_AUTHORITIES, new String[] {
                                        TaxiPartnerAccount.ACCOUNT_AUTHORITY
                                });
