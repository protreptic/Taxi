...
public final class EnumValueOptions extends AndroidMessage<EnumValueOptions, EnumValueOptions.Builder> {
  public static final ProtoAdapter<EnumValueOptions> ADAPTER = new ProtoAdapter_EnumValueOptions();

  public static final Parcelable.Creator<EnumValueOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public EnumValueOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option) {
    this(deprecated, uninterpreted_option, ByteString.EMPTY);
  }

  public EnumValueOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
