 ...
 */
public final class FieldDescriptorProto extends AndroidMessage<FieldDescriptorProto, FieldDescriptorProto.Builder> {
  public static final ProtoAdapter<FieldDescriptorProto> ADAPTER = new ProtoAdapter_FieldDescriptorProto();

  public static final Parcelable.Creator<FieldDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public FieldDescriptorProto(@Nullable String name, @Nullable Integer number, @Nullable Label label, @Nullable Type type, @Nullable String type_name, @Nullable String extendee, @Nullable String default_value, @Nullable Integer oneof_index, @Nullable FieldOptions options) {
    this(name, number, label, type, type_name, extendee, default_value, oneof_index, options, ByteString.EMPTY);
  }

  public FieldDescriptorProto(@Nullable String name, @Nullable Integer number, @Nullable Label label, @Nullable Type type, @Nullable String type_name, @Nullable String extendee, @Nullable String default_value, @Nullable Integer oneof_index, @Nullable FieldOptions options, ByteString unknownFields) {
