 ...
 * Describes a oneof.
 */
public final class OneofDescriptorProto extends AndroidMessage<OneofDescriptorProto, OneofDescriptorProto.Builder> {
  public static final ProtoAdapter<OneofDescriptorProto> ADAPTER = new ProtoAdapter_OneofDescriptorProto();

  public static final Parcelable.Creator<OneofDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public OneofDescriptorProto(@Nullable String name) {
    this(name, ByteString.EMPTY);
  }

  public OneofDescriptorProto(@Nullable String name, ByteString unknownFields) {
