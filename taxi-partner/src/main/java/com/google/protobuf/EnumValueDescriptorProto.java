 ...
 */
public final class EnumValueDescriptorProto extends AndroidMessage<EnumValueDescriptorProto, EnumValueDescriptorProto.Builder> {
  public static final ProtoAdapter<EnumValueDescriptorProto> ADAPTER = new ProtoAdapter_EnumValueDescriptorProto();

  public static final Parcelable.Creator<EnumValueDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public EnumValueDescriptorProto(@Nullable String name, @Nullable Integer number, @Nullable EnumValueOptions options) {
    this(name, number, options, ByteString.EMPTY);
  }

  public EnumValueDescriptorProto(@Nullable String name, @Nullable Integer number, @Nullable EnumValueOptions options, ByteString unknownFields) {
