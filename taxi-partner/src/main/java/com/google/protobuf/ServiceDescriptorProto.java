 ...
 * Describes a service.
 */
public final class ServiceDescriptorProto extends AndroidMessage<ServiceDescriptorProto, ServiceDescriptorProto.Builder> {
  public static final ProtoAdapter<ServiceDescriptorProto> ADAPTER = new ProtoAdapter_ServiceDescriptorProto();

  public static final Parcelable.Creator<ServiceDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public ServiceDescriptorProto(@Nullable String name, List<MethodDescriptorProto> method, @Nullable ServiceOptions options) {
    this(name, method, options, ByteString.EMPTY);
  }

  public ServiceDescriptorProto(@Nullable String name, List<MethodDescriptorProto> method, @Nullable ServiceOptions options, ByteString unknownFields) {
