 ...
 */
public final class SourceCodeInfo extends AndroidMessage<SourceCodeInfo, SourceCodeInfo.Builder> {
  public static final ProtoAdapter<SourceCodeInfo> ADAPTER = new ProtoAdapter_SourceCodeInfo();

  public static final Parcelable.Creator<SourceCodeInfo> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public static final class Location extends AndroidMessage<Location, Location.Builder> {
    public static final ProtoAdapter<Location> ADAPTER = new ProtoAdapter_Location();

    public static final Parcelable.Creator<Location> CREATOR = AndroidMessage.newCreator(ADAPTER);
    ...
    public Location(List<Integer> path, List<Integer> span, @Nullable String leading_comments, @Nullable String trailing_comments, List<String> leading_detached_comments) {
      this(path, span, leading_comments, trailing_comments, leading_detached_comments, ByteString.EMPTY);
    }

    public Location(List<Integer> path, List<Integer> span, @Nullable String leading_comments, @Nullable String trailing_comments, List<String> leading_detached_comments, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
