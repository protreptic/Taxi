 ...
 */
public final class MethodDescriptorProto extends AndroidMessage<MethodDescriptorProto, MethodDescriptorProto.Builder> {
  public static final ProtoAdapter<MethodDescriptorProto> ADAPTER = new ProtoAdapter_MethodDescriptorProto();

  public static final Parcelable.Creator<MethodDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public MethodDescriptorProto(@Nullable String name, @Nullable String input_type, @Nullable String output_type, @Nullable MethodOptions options, @Nullable Boolean client_streaming, @Nullable Boolean server_streaming) {
    this(name, input_type, output_type, options, client_streaming, server_streaming, ByteString.EMPTY);
  }

  public MethodDescriptorProto(@Nullable String name, @Nullable String input_type, @Nullable String output_type, @Nullable MethodOptions options, @Nullable Boolean client_streaming, @Nullable Boolean server_streaming, ByteString unknownFields) {
