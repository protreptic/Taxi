...
public final class MessageOptions extends AndroidMessage<MessageOptions, MessageOptions.Builder> {
  public static final ProtoAdapter<MessageOptions> ADAPTER = new ProtoAdapter_MessageOptions();

  public static final Parcelable.Creator<MessageOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public MessageOptions(@Nullable Boolean message_set_wire_format, @Nullable Boolean no_standard_descriptor_accessor, @Nullable Boolean deprecated, @Nullable Boolean map_entry, List<UninterpretedOption> uninterpreted_option) {
    this(message_set_wire_format, no_standard_descriptor_accessor, deprecated, map_entry, uninterpreted_option, ByteString.EMPTY);
  }

  public MessageOptions(@Nullable Boolean message_set_wire_format, @Nullable Boolean no_standard_descriptor_accessor, @Nullable Boolean deprecated, @Nullable Boolean map_entry, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
