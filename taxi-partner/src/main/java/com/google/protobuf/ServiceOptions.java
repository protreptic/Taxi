...
public final class ServiceOptions extends AndroidMessage<ServiceOptions, ServiceOptions.Builder> {
  public static final ProtoAdapter<ServiceOptions> ADAPTER = new ProtoAdapter_ServiceOptions();

  public static final Parcelable.Creator<ServiceOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public ServiceOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option) {
    this(deprecated, uninterpreted_option, ByteString.EMPTY);
  }

  public ServiceOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
