 ...
 */
public final class EnumDescriptorProto extends AndroidMessage<EnumDescriptorProto, EnumDescriptorProto.Builder> {
  public static final ProtoAdapter<EnumDescriptorProto> ADAPTER = new ProtoAdapter_EnumDescriptorProto();

  public static final Parcelable.Creator<EnumDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public EnumDescriptorProto(@Nullable String name, List<EnumValueDescriptorProto> value, @Nullable EnumOptions options) {
    this(name, value, options, ByteString.EMPTY);
  }

  public EnumDescriptorProto(@Nullable String name, List<EnumValueDescriptorProto> value, @Nullable EnumOptions options, ByteString unknownFields) {
