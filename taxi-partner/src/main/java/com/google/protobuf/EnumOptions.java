...
public final class EnumOptions extends AndroidMessage<EnumOptions, EnumOptions.Builder> {
  public static final ProtoAdapter<EnumOptions> ADAPTER = new ProtoAdapter_EnumOptions();

  public static final Parcelable.Creator<EnumOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public EnumOptions(@Nullable Boolean allow_alias, @Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option) {
    this(allow_alias, deprecated, uninterpreted_option, ByteString.EMPTY);
  }

  public EnumOptions(@Nullable Boolean allow_alias, @Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
