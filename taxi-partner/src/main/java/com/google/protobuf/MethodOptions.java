...
public final class MethodOptions extends AndroidMessage<MethodOptions, MethodOptions.Builder> {
  public static final ProtoAdapter<MethodOptions> ADAPTER = new ProtoAdapter_MethodOptions();

  public static final Parcelable.Creator<MethodOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public MethodOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option) {
    this(deprecated, uninterpreted_option, ByteString.EMPTY);
  }

  public MethodOptions(@Nullable Boolean deprecated, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
