 ...
 */
public final class DescriptorProto extends AndroidMessage<DescriptorProto, DescriptorProto.Builder> {
  public static final ProtoAdapter<DescriptorProto> ADAPTER = new ProtoAdapter_DescriptorProto();

  public static final Parcelable.Creator<DescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public DescriptorProto(@Nullable String name, List<FieldDescriptorProto> field, List<FieldDescriptorProto> extension, List<DescriptorProto> nested_type, List<EnumDescriptorProto> enum_type, List<ExtensionRange> extension_range, List<OneofDescriptorProto> oneof_decl, @Nullable MessageOptions options, List<ReservedRange> reserved_range, List<String> reserved_name) {
  ...
  public DescriptorProto(@Nullable String name, List<FieldDescriptorProto> field, List<FieldDescriptorProto> extension, List<DescriptorProto> nested_type, List<EnumDescriptorProto> enum_type, List<ExtensionRange> extension_range, List<OneofDescriptorProto> oneof_decl, @Nullable MessageOptions options, List<ReservedRange> reserved_range, List<String> reserved_name, ByteString unknownFields) {
  ...
  public static final class ExtensionRange extends AndroidMessage<ExtensionRange, ExtensionRange.Builder> {
    public static final ProtoAdapter<ExtensionRange> ADAPTER = new ProtoAdapter_ExtensionRange();

    public static final Parcelable.Creator<ExtensionRange> CREATOR = AndroidMessage.newCreator(ADAPTER);
    ...
    public ExtensionRange(@Nullable Integer start, @Nullable Integer end) {
      this(start, end, ByteString.EMPTY);
    }

    public ExtensionRange(@Nullable Integer start, @Nullable Integer end, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
      this.start = start;
      this.end = end;
    }
   ...
   * not overlap.
   */
  public static final class ReservedRange extends AndroidMessage<ReservedRange, ReservedRange.Builder> {
    public static final ProtoAdapter<ReservedRange> ADAPTER = new ProtoAdapter_ReservedRange();

    public static final Parcelable.Creator<ReservedRange> CREATOR = AndroidMessage.newCreator(ADAPTER);
    ...
    public ReservedRange(@Nullable Integer start, @Nullable Integer end) {
      this(start, end, ByteString.EMPTY);
    }

    public ReservedRange(@Nullable Integer start, @Nullable Integer end, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
      this.start = start;
      this.end = end;
    }
