 ...
 * in them.
 */
public final class UninterpretedOption extends AndroidMessage<UninterpretedOption, UninterpretedOption.Builder> {
  public static final ProtoAdapter<UninterpretedOption> ADAPTER = new ProtoAdapter_UninterpretedOption();

  public static final Parcelable.Creator<UninterpretedOption> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public UninterpretedOption(List<NamePart> name, @Nullable String identifier_value, @Nullable Long positive_int_value, @Nullable Long negative_int_value, @Nullable Double double_value, @Nullable ByteString string_value, @Nullable String aggregate_value) {
  ...
  public UninterpretedOption(List<NamePart> name, @Nullable String identifier_value, @Nullable Long positive_int_value, @Nullable Long negative_int_value, @Nullable Double double_value, @Nullable ByteString string_value, @Nullable String aggregate_value, ByteString unknownFields) {
   ...
   * "foo.(bar.baz).qux".
   */
  public static final class NamePart extends AndroidMessage<NamePart, NamePart.Builder> {
    public static final ProtoAdapter<NamePart> ADAPTER = new ProtoAdapter_NamePart();

    public static final Parcelable.Creator<NamePart> CREATOR = AndroidMessage.newCreator(ADAPTER);
