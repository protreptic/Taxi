 ...
 * files it parses.
 */
public final class FileDescriptorSet extends AndroidMessage<FileDescriptorSet, FileDescriptorSet.Builder> {
  public static final ProtoAdapter<FileDescriptorSet> ADAPTER = new ProtoAdapter_FileDescriptorSet();

  public static final Parcelable.Creator<FileDescriptorSet> CREATOR = AndroidMessage.newCreator(ADAPTER);
