 ...
 */
public final class FileOptions extends AndroidMessage<FileOptions, FileOptions.Builder> {
  public static final ProtoAdapter<FileOptions> ADAPTER = new ProtoAdapter_FileOptions();

  public static final Parcelable.Creator<FileOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public FileOptions(@Nullable String java_package, @Nullable String java_outer_classname, @Nullable Boolean java_multiple_files, @Nullable Boolean java_generate_equals_and_hash, @Nullable Boolean java_string_check_utf8, @Nullable OptimizeMode optimize_for, @Nullable String go_package, @Nullable Boolean cc_generic_services, @Nullable Boolean java_generic_services, @Nullable Boolean py_generic_services, @Nullable Boolean deprecated, @Nullable Boolean cc_enable_arenas, @Nullable String objc_class_prefix, @Nullable String csharp_namespace, List<UninterpretedOption> uninterpreted_option) {
  ...
  public FileOptions(@Nullable String java_package, @Nullable String java_outer_classname, @Nullable Boolean java_multiple_files, @Nullable Boolean java_generate_equals_and_hash, @Nullable Boolean java_string_check_utf8, @Nullable OptimizeMode optimize_for, @Nullable String go_package, @Nullable Boolean cc_generic_services, @Nullable Boolean java_generic_services, @Nullable Boolean py_generic_services, @Nullable Boolean deprecated, @Nullable Boolean cc_enable_arenas, @Nullable String objc_class_prefix, @Nullable String csharp_namespace, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
