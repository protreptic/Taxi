...
public final class FieldOptions extends AndroidMessage<FieldOptions, FieldOptions.Builder> {
  public static final ProtoAdapter<FieldOptions> ADAPTER = new ProtoAdapter_FieldOptions();

  public static final Parcelable.Creator<FieldOptions> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public FieldOptions(@Nullable CType ctype, @Nullable Boolean packed, @Nullable JSType jstype, @Nullable Boolean lazy, @Nullable Boolean deprecated, @Nullable Boolean weak, List<UninterpretedOption> uninterpreted_option) {
    this(ctype, packed, jstype, lazy, deprecated, weak, uninterpreted_option, ByteString.EMPTY);
  }

  public FieldOptions(@Nullable CType ctype, @Nullable Boolean packed, @Nullable JSType jstype, @Nullable Boolean lazy, @Nullable Boolean deprecated, @Nullable Boolean weak, List<UninterpretedOption> uninterpreted_option, ByteString unknownFields) {
