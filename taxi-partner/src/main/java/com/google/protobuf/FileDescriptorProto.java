 ...
 */
public final class FileDescriptorProto extends AndroidMessage<FileDescriptorProto, FileDescriptorProto.Builder> {
  public static final ProtoAdapter<FileDescriptorProto> ADAPTER = new ProtoAdapter_FileDescriptorProto();

  public static final Parcelable.Creator<FileDescriptorProto> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public FileDescriptorProto(@Nullable String name, @Nullable String package_, List<String> dependency, List<Integer> public_dependency, List<Integer> weak_dependency, List<DescriptorProto> message_type, List<EnumDescriptorProto> enum_type, List<ServiceDescriptorProto> service, List<FieldDescriptorProto> extension, @Nullable FileOptions options, @Nullable SourceCodeInfo source_code_info, @Nullable String syntax) {
  ...
  public FileDescriptorProto(@Nullable String name, @Nullable String package_, List<String> dependency, List<Integer> public_dependency, List<Integer> weak_dependency, List<DescriptorProto> message_type, List<EnumDescriptorProto> enum_type, List<ServiceDescriptorProto> service, List<FieldDescriptorProto> extension, @Nullable FileOptions options, @Nullable SourceCodeInfo source_code_info, @Nullable String syntax, ByteString unknownFields) {
