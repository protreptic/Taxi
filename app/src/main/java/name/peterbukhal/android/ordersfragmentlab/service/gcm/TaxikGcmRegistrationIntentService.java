 ...
 */
public class TaxikGcmRegistrationIntentService extends IntentService {

    public static final String LOG_TAG = "GcmRegistration";
    public static final String ACTION_GCM_REGISTRATION =
            "name.peterbukhal.android.ordersfragmentlab.service.gcm.action.ACTION_GCM_REGISTRATION";
    public static final String EXTRA_GCM_TOKEN = "extra_gcm_token";

    private LocalBroadcastManager broadcastManager;

    public TaxikGcmRegistrationIntentService() {
        super(LOG_TAG);
