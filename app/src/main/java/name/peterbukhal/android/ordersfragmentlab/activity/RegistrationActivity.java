...
import name.peterbukhal.android.ordersfragmentlab.account.TaxikAccount;
...
public class RegistrationActivity extends AccountAuthenticatorActivity {
    ...
    private void finishLogin(String authToken) {
        Account account = new Account(mUserName, TaxikAccount.ACCOUNT_TYPE);
        ...
        intent.putExtra(AccountManager.KEY_ACCOUNT_TYPE, TaxikAccount.ACCOUNT_TYPE);
