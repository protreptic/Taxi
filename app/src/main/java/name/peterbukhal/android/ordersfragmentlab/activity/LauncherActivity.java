...
import static name.peterbukhal.android.ordersfragmentlab.account.TaxikAccountManager.EXTRA_ACCOUNT;
import static name.peterbukhal.android.ordersfragmentlab.account.TaxikAccountManager.EXTRA_ACCOUNT_TOKEN;
import static name.peterbukhal.android.ordersfragmentlab.account.TaxikAccountManager.PickUpAccountAdapter.ADD_ACCOUNT_ITEM_ID;
...
public class LauncherActivity extends AppCompatActivity {
    ...
    private TaxikAccountManager mAccountManager;
    ...
    private void pickUpAccountDialog() {
        final TaxikAccountManager.PickUpAccountAdapter accountAdapter = mAccountManager.getAccountAdapter();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccountManager = TaxikAccountManager.get(getApplicationContext());
    }
